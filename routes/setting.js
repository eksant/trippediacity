...
Router.post('/', (req, res) => {
  Model.Setting.findAll().then(function (setting) {
    ...
    investment_value =
      investment_value == '' ? null : investment_value.replace(/,/g, '');
    ...
    let objSetting = {
      ...
      mail_port: parseInt(req.body.mail_port) || null,
      ...
      sales_tax: parseInt(req.body.sales_tax) || null,
      admin_fee: parseInt(req.body.admin_fee) || null,
      operating_costs: parseInt(req.body.operating_costs) || null,
    };
