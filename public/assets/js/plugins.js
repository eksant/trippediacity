	...
	var initDataTables = function() {
		if ($.fn.dataTable) {
			...
			$('.datatable').each(function () {
				...
				// Export
				if (self.hasClass('table-exports')) {
					$.extend(true, options, {
						"sDom": "<'row'<'dataTables_header clearfix'<'col-md-4'l><'col-md-8'BTf>r>>t<'row'<'dataTables_footer clearfix'<'col-md-6'i><'col-md-6'p>>>", //"Bfrtip",
						"aButtons": [
